...
class GestureClassifier(torch.nn.Module):
    def __init__(self, num_classes = 255):
        ...
        self.model = PerceiverIO(
            dim = self.input_dim,                    # dimension of sequence to be encoded
            queries_dim = 32,            # dimension of decoder queries
            logits_dim = self.num_classes,            # dimension of final logits
        ...
        self.position_emb = RotaryEmbedding(self.input_dim)
