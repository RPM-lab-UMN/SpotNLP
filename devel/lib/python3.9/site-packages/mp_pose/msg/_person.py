...
"""autogenerated by genpy from mp_pose/person.msg. Do not edit."""
import codecs
import sys
...
class person(genpy.Message):
  _md5sum = "b8b323dc61a88717bce4e8faa32bbfbe"
  _type = "mp_pose/person"
...
"""
  __slots__ = ['header','pose','image']
  _slot_types = ['std_msgs/Header','mp_pose/pose','sensor_msgs/Image']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.pose.local_landmarks)
      buff.write(_struct_I.pack(length))
      for val1 in self.pose.local_landmarks:
        _x = val1
        buff.write(_get_struct_5f().pack(_x.x, _x.y, _x.z, _x.visibility, _x.presence))
      length = len(self.pose.world_landmarks)
      buff.write(_struct_I.pack(length))
      for val1 in self.pose.world_landmarks:
        _x = val1
        buff.write(_get_struct_5f().pack(_x.x, _x.y, _x.z, _x.visibility, _x.presence))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.pose.local_landmarks.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pose.world_landmarks = []
      for i in range(0, length):
        val1 = mp_pose.msg.landmark()
        _x = val1
        start = end
        ...
        (_x.x, _x.y, _x.z, _x.visibility, _x.presence,) = _get_struct_5f().unpack(str[start:end])
        self.pose.world_landmarks.append(val1)
      _x = self
      start = end
      end += 12
